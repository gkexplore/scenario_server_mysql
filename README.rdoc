...
Scenario Server can be used to setup a quick local api server. 
...
Step 4: Clone scenario server in /var/www/  location. To do this, please follow the below steps
...
Step 5: Start the apache server
       ...
       To stop the scenario server  (sudo apachectl stop)
       To stop the scenario server  (sudo apachectl restart)
